...
const HomeHero = () => {
  return (
    <section className='section-module--hero min-h-screen'>
      <div className='relative z-20 flex flex-col gap-y-5 lg:flex-row items-center justify-center max-w-7xl'>
        <div className='home-hero-module--content flex flex-col items-center lg:items-start'>
          <div className='home-hero-module--info w-3/4 lg:max-w-[450px] font-Lato'>
            <h1 className='hero-title-module--title hero-title-module--light !font-bold text-5xl !text-center lg:text-left'>
              Use your NFTs to get a crypto loan
            </h1>
            <p className='hero-text-module--text hero-text-module--light !text-center lg:text-left'>
